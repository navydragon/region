                ...
                <div class="display-table">
                    <div class="display-table-cell vertical-align-middle">
                        ...
                        <div class="container text-center">
                            ...
                            <h1 class="nomargin size-50 weight-300 wow fadeInUp" data-wow-delay="0.4s">Система проведения комиссий по проверке знаний требований охраны труда в ОАО "РЖД"</h1>
                            <p class="lead font-lato size-30 wow fadeInUp" data-wow-delay="0.7s">Для начала работы</p>
                            
                            <div class="margin-top-30">
                                <a href="login" class="btn btn-3d btn-lg btn-teal"><i class="glyphicon glyphicon-th-large"></i>ВОЙДИТЕ</a>
                                <span class="size-17 hidden-xs">&nbsp; ИЛИ &nbsp;</span>
                                <a href="register" class="btn btn-3d btn-lg btn-red"><i class="glyphicon glyphicon-user"></i>ЗАРЕГИСТРИРУЙТЕСЬ</a>
                            </div>
